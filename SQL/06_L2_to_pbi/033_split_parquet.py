...
# output_dir = input_path.parent / "l2_sales_long/splits"  # creates SQL/outputs/parquet/splits
...
input_path = Path("SQL/outputs/parquet/l2_sales_long_extended.parquet")
rows_per_file = 1_000_000  # adjust as needed for Power BI comfort
output_dir = input_path.parent / "splits"  # creates SQL/outputs/parquet/splits
output_prefix = "l2_sales_long_extended/l2_sales_long_extended"
